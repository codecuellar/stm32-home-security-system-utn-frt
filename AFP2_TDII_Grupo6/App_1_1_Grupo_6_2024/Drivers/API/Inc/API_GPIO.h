...
// Definición del tipo de dato para representar los LEDs
typedef enum {
...
// Tipo de dato para representar el estado de un botón
typedef bool buttonStatus_t;

// Prototipos de las funciones
void MX_GPIO_Init(void);  // Inicialización del GPIO
void LED_On(led_T led);   // Encender LED
void LED_Off(led_T led);  // Apagar LED
void LED_Toggle(led_T led); // Invertir el estado del LED
buttonStatus_t readButton_GPIO(void);  // Lectura del estado del botón
